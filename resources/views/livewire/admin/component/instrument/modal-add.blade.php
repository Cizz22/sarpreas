<div class="p-4">
    ...
    <form class="w-full max-w-full" wire:submit.prevent="submit" autocomplete="off">
        <div class="flex flex-wrap mb-6">
            <x-input-label for="name" value="Instrument" />

            <x-text-input id="name" class="block mt-2 w-full" wire:model.lazy="instrument" type="text"
                name="instrument" autofocus />
        ...
        <div class="flex flex-wrap mb-6">
            <x-input-label for="name" value="Unit" />
            <select
