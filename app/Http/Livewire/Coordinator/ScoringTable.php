...
final class ScoringTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    {
        $subunit = Subunit::query()->where('coordinator_id', $this->coordinator_id);
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ->addColumn('id')
            ->addColumn('name')
            ->addColumn('name_lower', fn (Subunit $model) => strtolower(e($model->name)))
    ...
    public function actions(): array
    {
       return [
           Button::make('edit', 'Edit')
               ...
               ->route('subunit.edit', ['subunit' => 'id']),

           Button::make('destroy', 'Delete')
               ->class('bg-red-500 cursor-pointer text-white px-3 py-2 m-1 rounded text-sm')
               ->route('subunit.destroy', ['subunit' => 'id'])
               ->method('delete')
        ];
    }
    */
